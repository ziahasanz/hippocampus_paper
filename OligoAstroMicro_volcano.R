...
path <- "~/you_file_path/OligoAstroMicro_DEGs/astro" #load the data from the OligoAstroMicro_DEGs, for examples; for astrocytes from astro folder
...
ggsave("astro.pdf",  plot = grid_plot, width = 14, height = 6, dpi = 400)
ggsave("astro.tiff", plot = grid_plot, width = 14, height = 6, dpi = 600, device = "tiff")
