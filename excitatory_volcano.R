...
path <- "~/you_file_path/ex_DEGs/Cluster_#" #load the data from the ex_DEGs, for examples Cluster_1
...
#ggsave("ex_cluster_#.pdf",  plot = grid_plot, width = 14, height = 6, dpi = 400)
#ggsave("ex_cluster_#.tiff", plot = grid_plot, width = 14, height = 6, dpi = 600, device = "tiff")
